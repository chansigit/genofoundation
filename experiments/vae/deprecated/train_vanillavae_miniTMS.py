"""
Train Vanilla VAE on mini TMS dataset.

Usage:
    python train_vanillavae_miniTMS.py
    python train_vanillavae_miniTMS.py trainer.epochs=100 trainer.batch_size=128
"""
...
@hydra.main(
    config_path="configs",
    config_name="vanillavae_miniTMS",
    version_base=None,
)
